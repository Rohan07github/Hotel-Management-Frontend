        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src={hotelImg} alt="Luxora Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="rohn-color">Luxora Hotel</span>
                        </h1>
                        <br />
            ...
            <h4>
                <a className="view-rooms-home" href="/rooms">All Rooms</a>
            </h4>

            <h2 className="home-services">
                Services at <span className="rohan-color">Luxora Hotel</span>
            </h2>
